...
export default function SectionHeader(section: Section): React.ReactNode {
  return (
    <div
      className={`select-none w-auto h-11 m-5 bg-[#6B6C76] z-5 relative opacity-90 bg-blend-overlay`}
    >
      <div className="flex flec-col">
        ...
        <div className="absolute right-0 mr-4 mt-2 flex flex-row text-lg">
          <p className="align-middle font-bold">total weight</p>

...
export default class Utils {
  static sortKeysReplacer = (_key: string, value: unknown) =>
    value instanceof Object && !(value instanceof Array)
      ? Object.keys(value)
          .sort()
          .reduce((sorted: object, k: string) => {
            // @ts-expect-error: generic object types
            sorted[k] = value[k];
            return sorted;
          }, {})
      : value;

  static getObjectDifferences<T extends Record<string, unknown>>(obj1: T, obj2: T): Partial<T> {
    ...
    for (const key in obj1) {
      if (Object.prototype.hasOwnProperty.call(obj1, key)) {
        ...
        if (Array.isArray(val1) && Array.isArray(val2)) {
          const arrayDiff = this.getArrayDifference(val1, val2);
          ...
          const nestedDiff = this.getObjectDifferences(
  ...
  static identicalArrays<T>(arr1: T[], arr2: T[]): boolean {
